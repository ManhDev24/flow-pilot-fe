    ...
    <Card className='p-4 h-full flex flex-col w-full'>
      ...
      <div className='flex-1 space-y-4 mb-4 overflow-auto'>
        ...
        <div className='flex justify-center my-2'>
          <span className='bg-gray-100 text-gray-500 text-xs px-2 py-1 rounded'>Công việc</span>
        </div>
        ...
        {/* Additional conversation items to fill space */}
        <div className='text-sm text-gray-600'>
          Based on the performance data, I can provide detailed insights about productivity trends, task completion rates, and collaboration effectiveness. What specific metrics would you like me to analyze?
        </div>

        <div className='bg-blue-600 text-white p-3 rounded-lg text-sm max-w-xs ml-auto'>
          Show me the team's overall productivity trends.
        </div>

        <div className='text-sm text-gray-600'>
          The team shows consistent improvement with 23% increase in task completion rates and 18% better on-time delivery compared to last quarter. Communication and collaboration scores are also trending upward.
        </div>
      </div>
