      ...
      <DialogContent className='sm:max-w-[400px] p-0'>
        <div className='px-6 py-8 text-center'>
          ...
          <p className='text-sm text-gray-500 mb-6'>
            Are you sure you want to permanently delete <span className='font-medium'>"{projectName}"</span> project?
            All project data and associated tasks will be permanently removed. This action cannot be undone.
          </p>
