...
const consultationSchema = yup.object().shape({
  ...
  phone: yup
    ...
    .test('vietnam-phone', 'Số điện thoại không đúng định dạng Việt Nam', function(value) {
      ...
      // - Mobile: 09x, 03x, 07x, 08x, 05x (10 digits starting with 0)
      // - International: +849x, +843x, +847x, +848x, +845x (12 digits starting with +84)
      const vietnamMobilePattern = /^0[3578][0-9]{8}$/;
      const vietnamInternationalPattern = /^\+84[3578][0-9]{8}$/;
      
      return vietnamMobilePattern.test(cleanPhone) || vietnamInternationalPattern.test(cleanPhone);
    }),
  company_name: yup
    .string()
    .trim(),
